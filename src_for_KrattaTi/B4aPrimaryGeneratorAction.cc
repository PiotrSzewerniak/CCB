  ...
  :myDetector(myDC),bt(0)
{
  ...
  particleDefinition 
   ...
   p_mass = particleDefinition->GetPDGMass()/1000.;
   
  particleDefinition 
    = G4ParticleTable::GetParticleTable()->FindParticle("He3");
     particleGun2->SetParticleDefinition(particleDefinition);
   He3_mass = particleDefinition->GetPDGMass()/1000.;
...
{  // output : bp1,bp2,thcos2
  ...
  G4double ep3l,ep4l,p3l,e3,e4,p4l,cosang4;  				  //auxillary variable
  G4double bej, ang4;

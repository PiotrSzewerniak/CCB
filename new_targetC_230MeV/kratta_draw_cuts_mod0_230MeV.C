...
void kratta_draw_cuts_mod0_230MeV(){
  ...
  p10_vs_p12p13st2=(TH2F*)f2->Get("p10_vs_p12p13st_mod0")->Clone();
  p10_vs_p12p13stCut2=(TH2F*)f2->Get("p10_vs_p12p13stCut_mod0")->Clone();
  am1_vs_am2_2=(TH2F*)f2->Get("am1_vs_am2_mod0")->Clone();
  am1_vs_am2_Cut2=(TH2F*)f2->Get("am1_vs_am2_Cut_mod0")->Clone();
  
  f3->cd();
  cut1=(TCutG*)f3->Get("cut_p10_vs_p12p13st_mod0")->Clone(); 
  cut2=(TCutG*)f3->Get("cut_am1_vs_am2_mod0")->Clone(); 
...
//###############################
 ...
 TCanvas *c2 = new TCanvas("cuts_Ctarget_mod0","cuts_Ctarget_mod0");
 c2->Divide(3,2);
...
//###############################
  ...
  TCanvas *c1 = new TCanvas("cuts_noTarget_mod0","cuts_noTarget_mod0");
  c1->Divide(3,2);

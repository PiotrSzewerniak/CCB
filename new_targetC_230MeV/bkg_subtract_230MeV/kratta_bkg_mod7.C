...
TFile *f1 = new TFile("/home/ciepal/uczelnia/Kratta/spall-2017-06/new/KRATTA_histos_230MeV.root");
TFile *f2 = new TFile("/home/ciepal/uczelnia/Kratta/spall-2017-06/new/KRATTA_histos_7334_7345.root");
//TFile *f2 = new TFile("/home/ciepal/uczelnia/Kratta/spall-2017-06/new/KRATTA_histos_7043_7048.root");
...
void kratta_bkg_mod7(){
  
  //Float_t scale=2.52;
  //Float_t scale=1.;//7043-7048
  Float_t scale=1.42;//7334-7345
  
  
  f1->cd();
  h_protEn=(TH1F*)f1->Get("en_prot_mod7")->Clone();
  //h_protEn_empty->SetName("elastic_said");
  h_protEnc1=(TH1F*)f1->Get("en_prot_mod7")->Clone();

  f2->cd();
  h_protEn_empty=(TH1F*)f2->Get("en_prot_mod7")->Clone(); 
  h_protEn_emptyc1=(TH1F*)f2->Get("en_prot_mod7")->Clone();
  h_protEn_emptyc2=(TH1F*)f2->Get("en_prot_mod7")->Clone();
...
h_protEn_new->Add(h_protEn,h_protEn_empty,1.,-1.);
 ...
 TCanvas *c1a = new TCanvas("bkgSub_mod7","bkgSub_mod7");
 c1a->Divide(3,1);
 ...
 //h_protEn_emptyc1->Draw(); 
 //h_protEnc1->Draw("same"); 

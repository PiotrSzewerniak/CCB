...
void kratta_bkg_mod0(){
  
  //Float_t scale=2.52;
  Float_t scale=1.42;
  
  f1->cd();
  h_protEn=(TH1F*)f1->Get("en_prot_mod0")->Clone();
  //h_protEn_empty->SetName("elastic_said");
  h_protEnc1=(TH1F*)f1->Get("en_prot_mod0")->Clone();

  f2->cd();
  h_protEn_empty=(TH1F*)f2->Get("en_prot_mod0")->Clone(); 
  h_protEn_emptyc1=(TH1F*)f2->Get("en_prot_mod0")->Clone();
  h_protEn_emptyc2=(TH1F*)f2->Get("en_prot_mod0")->Clone();
...
h_protEn_new->Add(h_protEn,h_protEn_empty,1.,-1.);
 ...
 TCanvas *c1a = new TCanvas("bkgSub_mod0","bkgSub_mod0");
 c1a->Divide(3,1);

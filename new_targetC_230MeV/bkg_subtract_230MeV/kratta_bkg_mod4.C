...
void kratta_bkg_mod4(){
  ...
  f1->cd();
  h_protEn=(TH1F*)f1->Get("en_prot_mod4")->Clone();
  //h_protEn_empty->SetName("elastic_said");
  h_protEnc1=(TH1F*)f1->Get("en_prot_mod4")->Clone();

  f2->cd();
  h_protEn_empty=(TH1F*)f2->Get("en_prot_mod4")->Clone(); 
  h_protEn_emptyc1=(TH1F*)f2->Get("en_prot_mod4")->Clone();
  h_protEn_emptyc2=(TH1F*)f2->Get("en_prot_mod4")->Clone();
...
h_protEn_new->Add(h_protEn,h_protEn_empty,1.,-1.);
 ...
 TCanvas *c1a = new TCanvas("bkgSub_mod4","bkgSub_mod4");
 c1a->Divide(3,1);

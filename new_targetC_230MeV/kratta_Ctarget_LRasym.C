...
//TFile *f2 = new TFile("KRATTA_histos_130MeV.root");

TH1F * h_protEn0_1, *h_protEn7_1;
TH1F * h_protEn4_1, *h_protEn11_1;

TH1F * h_protEn4_2, *h_protEn11_2;

void kratta_Ctarget_LRasym(){
...
TPaveText *pt1 = new TPaveText(x1,y1,x2,y2,"NDC");
 ...
 TCanvas *c1 = new TCanvas("LRasym_Ctarget","LRasym_Ctarget");
 c1->Divide(2,1);

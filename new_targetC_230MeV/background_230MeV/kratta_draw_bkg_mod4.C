...
void kratta_draw_bkg_mod4(){
  ...
  f3->cd();
  h_protEn3=(TH1F*)f3->Get("en_prot_mod4")->Clone(); 
  p10_vs_p12p13st3=(TH2F*)f3->Get("p10_vs_p12p13st_mod4")->Clone();
  p10_vs_p12p13stCut3=(TH2F*)f3->Get("p10_vs_p12p13stCut_mod4")->Clone();
  am1_vs_am2_3=(TH2F*)f3->Get("am1_vs_am2_mod4")->Clone();
  am1_vs_am2_Cut3=(TH2F*)f3->Get("am1_vs_am2_Cut_mod4")->Clone();
 ...
 TCanvas *c1a = new TCanvas("bkg_comp_mod4","bkg_comp_mod4");
 c1a->Divide(1,0);
...
//###############################
 ...
 TCanvas *c2 = new TCanvas("2D_comp1_mod4","2D_comp1_mod4");
 c2->Divide(3,1);
...
//###############################
 ...
 TCanvas *c3 = new TCanvas("2D_comp2_mod4","2D_comp2_mod4");
 c3->Divide(3,1);
